...
\entry{Ko\c{c} University}{Istanbul, Turkey}{M.A. in Economics (GPA: 3.92/4.0)}{2008 -- 2010}
\begin{itemize}
    \item Master's research in formal economic modelling of organisational design and strategic communication, examining centralised versus decentralised decision-making under alternative information structures, complementarities, and externalities.
\end{itemize}

\entry{Ko\c{c} University}{Istanbul, Turkey}{B.Sc. in Electrical \& Electronics Engineering (GPA: 3.48/4.0)}{2003 -- 2008}
...
\textit{Senior Research Assistant} \hfill 2021 -- 2022
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Tools:} Git, Google Earth Engine, AWS, \LaTeX.
\end{itemize}
